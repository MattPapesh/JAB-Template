 ...
 * methods must be overridden in AppBase's subclass, App.java. 
 */
public interface AppInterface 
{
    /**
     * Meant to be overridden with the intent to be used to determine the application's current status. Moreover,
